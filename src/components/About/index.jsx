...
import "./About.css"
import { profile11 } from '../../images'; // Correct import
    ...
    <section id='about' ref={container}>
      <div className="section__wrapper about__container">
        ...
        <div className="section__header">
          ...
          <h1 className="title">I am <span className="color__primary">Vijayakumar</span></h1>
          <p className="text__muted description">
           Full Stack Developer with a passion for creating dynamic, intuitive, and
